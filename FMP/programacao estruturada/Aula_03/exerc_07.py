...
lata = int(input('Bom dia, quantas latas de Meia-Cola o senhor vai querer comprar hoje: '))
g600 = int(input('Bom dia, quantas garrafas de 600ml de Meia-Cola o senhor vai querer comprar hoje: '))
g2 = int(input('Bom dia, quantas garrafas de 2ml de Meia-Cola o senhor vai querer comprar hoje: '))
litros_lata = lata * 0.350
litros_g600 = g600 * 0.6
litros_g2 = g2 * 2
litros_total = int(litros_lata + litros_g600 + litros_g2)
